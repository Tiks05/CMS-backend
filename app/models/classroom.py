...
class Classroom(db.Model):
    ...
    category_type: Mapped[str] = mapped_column(String(50), nullable=True, comment='分类标签')  # 如 live / writing 等
    ...
    is_include_video: Mapped[bool] = mapped_column(Boolean, default=False, comment='是否展示视频按钮')
