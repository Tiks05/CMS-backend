...
class News(db.Model):
    ...
    type: Mapped[str] = mapped_column(String(16), default='notice', comment='类型：notice资讯，active活动')
    created_at: Mapped[DateTime] = mapped_column(DateTime, server_default=func.now(), comment='发布时间')
