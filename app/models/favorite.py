...
class Favorite(db.Model):
    ...
    user_id: Mapped[int] = mapped_column(Integer, ForeignKey('user.id'), nullable=False, comment='收藏者ID')
    book_id: Mapped[int] = mapped_column(Integer, ForeignKey('book.id'), nullable=False, comment='被收藏的小说ID')
