...
class Book(db.Model):
    ...
    user_id: Mapped[int] = mapped_column(Integer, ForeignKey('user.id'), nullable=False, comment='作者ID')
    ...
    favorite_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False, comment='被收藏数量')
    sign_status: Mapped[str] = mapped_column(String(16), default='未签约', comment='签约状态 未签约/已签约')
